          ...
          <div className="flex items-center gap-3.5 mb-5">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="inline-flex items-center rounded-full px-2 py-0.5 text-sm font-medium bg-muted text-muted-foreground capitalize">
                  {user?.role}
                </span>
              </div>
          ...
          <div className="border-t pt-5">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-8">
              ...
              <div>
                ...
                <p className="text-base font-normal capitalize">{user?.role}</p>
              </div>
              <div>
